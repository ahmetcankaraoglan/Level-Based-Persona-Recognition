...
# - Simply segment new customer definitions using the qcut function. According to the price.
# - When a new customer arrives, to classify this customer by segments.

# Our goal is to make groupings (level based persona definition) for customers that exist individually.
# then is to segment these groups.
# Finally, it is trying to determine which of these segments a new customer belongs to.
# What should be obtained before and after the output will be as follows:
